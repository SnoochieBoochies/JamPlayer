...
public class MusicIntentReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent.getAction().equals(android.media.AudioManager.ACTION_AUDIO_BECOMING_NOISY)) {
            ...
            context.startService(new Intent(JamService.ACTION_PAUSE));
            ...
            switch (keyEvent.getKeyCode()) {
                ...
                case KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE:
                    context.startService(new Intent(JamService.ACTION_TOGGLE_PLAYBACK));
                    break;
                case KeyEvent.KEYCODE_MEDIA_PLAY:
                    context.startService(new Intent(JamService.ACTION_PLAY));
                ...
                case KeyEvent.KEYCODE_MEDIA_PREVIOUS:
                    ...
                    // previous song
                    context.startService(new Intent(JamService.ACTION_REWIND));
                    break;
            }
        }
    }
